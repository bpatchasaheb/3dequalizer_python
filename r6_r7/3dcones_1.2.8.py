...
tde4.addMenuWidget(req,"presets_menu","Presets","menu_bar",1)
...
tde4.addMenuButtonWidget(req,"reset_ui_menu_btn","Reset UI","reset_menu")
...
tde4.setWidgetCallbackFunction(req, "rot_x_txt_value", "rotation_callback")
tde4.setWidgetCallbackFunction(req, "rot_y_txt_value", "rotation_callback")
tde4.setWidgetCallbackFunction(req, "rot_z_txt_value", "rotation_callback")

tde4.setWidgetCallbackFunction(req, "show_all_models_menu_btn", "view_menu_callback")
tde4.setWidgetCallbackFunction(req, "hide_all_models_menu_btn", "view_menu_callback")
tde4.setWidgetCallbackFunction(req, "show_sel_models_menu_btn", "view_menu_callback")
tde4.setWidgetCallbackFunction(req, "hide_sel_models_menu_btn", "view_menu_callback")

tde4.setWidgetCallbackFunction(req, "select_all_models_menu_btn", "select_menu_callback")
tde4.setWidgetCallbackFunction(req, "select_model_on_point_menu_btn", "select_menu_callback")
tde4.setWidgetCallbackFunction(req, "select_points_menu_btn", "select_menu_callback")

tde4.setWidgetCallbackFunction(req, "color_menu", "color_menu_callback")
tde4.setWidgetCallbackFunction(req, "color_red_slider", "color_slider_callback")
tde4.setWidgetCallbackFunction(req, "color_green_slider", "color_slider_callback")
...
tde4.setWidgetCallbackFunction(req, "reset_ui_menu_btn", "reset_ui_settings_callback")
