...
tde4.setWidgetOffsets(req,"create_key_btn",5,10,7,0)
tde4.setWidgetAttachModes(req,"create_key_btn","ATTACH_WIDGET","ATTACH_WIDGET","ATTACH_WIDGET","ATTACH_NONE")
tde4.setWidgetSize(req,"create_key_btn",50,20)
tde4.addButtonWidget(req,"delete_key_btn","Delete Key")
tde4.setWidgetOffsets(req,"delete_key_btn",70,10,7,0)
tde4.setWidgetAttachModes(req,"delete_key_btn","ATTACH_WIDGET","ATTACH_WIDGET","ATTACH_WIDGET","ATTACH_NONE")
tde4.setWidgetSize(req,"delete_key_btn",60,20)
tde4.addButtonWidget(req,"update_viewport_btn","Update Viewport")
tde4.setWidgetOffsets(req,"update_viewport_btn",105,5,7,0)
tde4.setWidgetAttachModes(req,"update_viewport_btn","ATTACH_WIDGET","ATTACH_WINDOW","ATTACH_WIDGET","ATTACH_NONE")
tde4.setWidgetSize(req,"update_viewport_btn",130,20)
tde4.addToggleWidget(req,"main_wdgt_auto_key","Auto Key",1)
tde4.setWidgetOffsets(req,"main_wdgt_auto_key",84,0,8,0)
...
tde4.setWidgetLinks(req,"create_key_btn","curve_area_wdgt","delete_key_btn","layers_list_wdgt","")
tde4.setWidgetLinks(req,"delete_key_btn","curve_area_wdgt","update_viewport_btn","layers_list_wdgt","")
...
tde4.setWidgetCallbackFunction(req, "delete_key_btn", "delete_key_callback")
